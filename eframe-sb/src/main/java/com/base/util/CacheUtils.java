...
public class CacheUtils {
	...
	public static String REDIS_SERVER = PropertiesUtil.getProperty("redis.jedis.server");
	
	public static String REDIS_DATABASE = PropertiesUtil.getProperty("redis.jedis.database");
	
	public static String REDIS_PASSWORD = PropertiesUtil.getProperty("redis.jedis.requirepass");
	
	public static String REDIS_MAX_ACTTVE = PropertiesUtil.getProperty("redis.jedis.maxActive");
	
	public static String REDIS_MAX_IDLE = PropertiesUtil.getProperty("redis.jedis.maxIdle");
	
	public static String REDIS_MAX_WAIT = PropertiesUtil.getProperty("redis.jedis.maxWait");
	
	public static String REDIS_TEST_ON_BORROW = PropertiesUtil.getProperty("redis.jedis.testOnBorrow");
